//! Error types for the runtime XDG desktop portal backend.

use std::io;

/// Errors produced by portal session, D-Bus, Wayland, and PipeWire flows.
...
/// Convert internal portal errors to D-Bus-facing errors.
