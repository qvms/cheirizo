...
//!
//! Defines protocol-availability flags derived from compositor globals during
//! runtime registry binding.

/// Available Wayland protocols detected from compositor globals.
///
/// Covers capture, input, clipboard, and core seat/output capabilities used
/// by the runtime portal backend.
#[derive(Debug, Default, Clone)]
pub struct AvailableProtocols {
    // === Screen Capture ===
    /// ext-image-copy-capture-v1 (preferred).
