...
#ifndef WRDP_COMPOSITOR_VIEW_H
#define WRDP_COMPOSITOR_VIEW_H
...
/*
 * In wrdp-compositor, a view is a container for surfaces which can be moved around by
...
enum view_wants_focus {
	 ...
	 * (a.k.a. ICCCM Globally Active input model). wrdp-compositor generally
