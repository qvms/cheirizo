...
#ifndef WRDP_COMPOSITOR_LIST_H
#define WRDP_COMPOSITOR_LIST_H
 ...
 *
 * Note: In wrdp-compositor, most lists are queues where we want to add new elements to
