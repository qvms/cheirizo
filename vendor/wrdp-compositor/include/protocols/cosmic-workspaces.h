...
#ifndef WRDP_COMPOSITOR_PROTOCOLS_COSMIC_WORKSPACES_H
#define WRDP_COMPOSITOR_PROTOCOLS_COSMIC_WORKSPACES_H
...
#endif /* WRDP_COMPOSITOR_PROTOCOLS_COSMIC_WORKSPACES_H */
