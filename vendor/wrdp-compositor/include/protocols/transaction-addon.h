...
#ifndef WRDP_COMPOSITOR_PROTOCOLS_TRANSACTION_ADDON_H
#define WRDP_COMPOSITOR_PROTOCOLS_TRANSACTION_ADDON_H
...
#endif /* WRDP_COMPOSITOR_PROTOCOLS_TRANSACTIONS_ADDON_H */
