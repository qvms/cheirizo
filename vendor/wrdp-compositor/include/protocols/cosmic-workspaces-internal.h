...
#ifndef WRDP_COMPOSITOR_PROTOCOLS_COSMIC_WORKSPACES_INTERNAL_H
#define WRDP_COMPOSITOR_PROTOCOLS_COSMIC_WORKSPACES_INTERNAL_H
...
#endif /* WRDP_COMPOSITOR_PROTOCOLS_COSMIC_WORKSPACES_INTERNAL_H */
