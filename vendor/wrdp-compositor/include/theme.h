...
#ifndef WRDP_COMPOSITOR_THEME_H
#define WRDP_COMPOSITOR_THEME_H
 ...
 * @theme: theme data
 * @server: server
 * @theme_name: theme-name in <theme-dir>/<theme-name>/wrdp-compositor/themerc
